...
#if !defined(AFX_REGISTYINTERFACE_H__9DE92E42_953C_11D7_8464_00B0D0CDB4FC__INCLUDED_)
#define AFX_REGISTYINTERFACE_H__9DE92E42_953C_11D7_8464_00B0D0CDB4FC__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000

class CRegistyInterface
{
public:
	static void SetUpFileTypes();
private:
	static void DefaultRegSet(CString SubKey, CString Data);
	static void RegSetEditFlags(CString SubKey);
	static CString DefaultRegGet(CString SubKey);
};

#endif // !defined(AFX_REGISTYINTERFACE_H__9DE92E42_953C_11D7_8464_00B0D0CDB4FC__INCLUDED_)
